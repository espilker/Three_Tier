...
let prefix="https://script.google.com/macros/s/AKfycbyuCpUcQ51obd4gFBeVbQFcBBMs8NeGPl91iocf43dt0fO27N9TMSzyEky4-kGJ0z4q/exec"
            ...
            switch(params[2]){                           // params[2] is the field name 
                case "first_name":                       // validating the first_name field of the employee table  
                    ...
                    if(this.value.length < 2){
                        this.focus()
                        alert("First name ust at least be two characters")
                        return
                    }
                    break
                default:    
